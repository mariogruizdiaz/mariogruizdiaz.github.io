module.exports = {
    en: {
        ...
        signUp: {
          ...
          email: "Email",
          password: "Password",
          specificationPassword: "The password must contain at least: One uppercase letter. One lowercase letter. One number. One special character from the list !@#$%^&*()-_=+{}[]:;'\"<>,?/|\\`~. A length between 6 and 15 characters.",
        ...
        download: {
          ...
          title: 'At Adme everyone is an influencer',
          subtitle: 'Adme is the app that connects you directly with advertising campaigns and allows you to earn rewards for being part of them. It is more than just an app, it is your portal to the new way of generating content and being rewarded for it.',
          downloadTitle: 'Discover Adme',
          downloadSubtitle: 'Use this referral code for your account creation.',
          bodyTitle: 'How to get started?',
          bodySubtitle: 'Follow these simple steps to start earning through Adme.',
          step1Title: 'Download the App',
          step1Subtitle: 'Click the button above and start enjoying Adme now.',
          step2Title: 'Enter a referral code',
          step2Subtitle: 'You can copy this code or use a friend´s code if they already downloaded it before.',
          step3Title: 'Register',
          step3Subtitle: 'Fill in the necessary information so we can provide you with campaigns that fit your profile.',
          step4Title: 'Link your social networks',
          step4Subtitle: 'To publish the content you want on them, automatically using Adme.',
        ...
        brands: {
          howTostart: {
            ...
            addCompanyOkSubtitle: '. You are part of Adme, congratulations!',
            ...
            createCampaignOk3Subtitle: 'We’ve noticed that you created a campaign. Do you want to create more? Contact us.',
          ...
          valueProposition: {
            ...
            step5Title: 'Monitor their campaigns in real time',
        ...
        hero: {
            title: "Adme, transform your posts into income",
            subtitle: "In Adme you are an Influencer! Simply use the app to post on Facebook, Twitter, Instagram and receive money",
            videoUrl: "https://www.youtube.com/watch?v=ZpkI--1X8UI",
        },
        about: {
            title: 'Why Adme is different?',
            subtitle: 'Adme recognizes you as the main protagonist in the world of social networks. No matter how many friends/followers you have in your social networks, Adme considers you an Influencer and therefore pays money to you',
            ...
            reason3Subtitle: 'Adme pays you a percentage of the money your referrals continually earn. So the more people in your network, the more money you will earn passively.',
        },
        counters: {
    ...
    es: {
       ...
       login: {
        ...
        signUp: {
          ...
          email: "Correo electrónico",
          password: "Contraseña",
          specificationPassword: "La contraseña debe contener al menos: Una letra mayúscula. Una letra minúscula. Un número. Un carácter especial de la lista !@#$%^&*()-_=+{}[]:;'\"<>,?/|\\`~. Una longitud de entre 6 y 15 caracteres.",
        ...
        download: {
          ...
          subtitle: 'Adme es la aplicación que te conecta directamente con campañas publicitarias y te permite ganar recompensas por ser parte de ellas. Es más que una simple app, es tu portal hacia la nueva forma de generar contenido y ser recompensado por eso.',
          downloadTitle: 'Descubrí Adme',
          downloadSubtitle: 'Usá este código de referido para tu creación de cuenta.',
          bodyTitle: '¿Cómo empezar?',
          bodySubtitle: 'Sigue estos simples pasos para empezar a ganar a través de Adme.',
          step1Title: 'Descargá la App',
          step1Subtitle: 'Hace clic en el botón de arriba y comenzá a disfrutar ya de Adme.',
          step2Title: 'Ingresá un código de referido',
          step2Subtitle: 'Podés copiar este código o bien usar el de un amig@ si ya se la descargo antes.',
          step3Title: 'Registraté',
          step3Subtitle: 'Completá la info necesaria para poder brindarte campañas que se ajusten a tu perfil.',
        ...
        brands: {
          howTostart: {
            ...
            addCompanyOkSubtitle: '. ¡Ya sos parte de Adme, felicitaciones!',
        ...
        about: {
            ...
            reason3Subtitle: 'Adme te paga un porcentaje del dinero que continuamente ganan tus referidos y los referidos de tus referidos. Ganás dinero de manera pasiva.',
        },
        counters: {
        ...
        features: {
            ...
            subtitle: "Adme es la primer plataforma que cree que todo usuario de redes sociales es un influencer. Es por esta razón que Adme transforma los benefícios que las marcas obtinen por las influencias de tus fotos en recompensas monetarias al protagonista de toda esta historia, vos 🤟",

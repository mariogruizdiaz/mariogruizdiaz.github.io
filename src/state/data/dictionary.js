module.exports = {
    en: {
        ...
        download: {
          ...
          subtitle: 'Adme is the app that connects you directly with advertising campaigns and allows you to earn rewards for participating in them. It’s more than just an app; it’s your gateway to a new way of creating content and being rewarded for it.',
          ...
          step4Subtitle: 'To automatically post the content you want on them through Adme.',
    ...
    es: {
       ...
       login: {
        ...
        download: {
          ...
          subtitle: 'Adme es la aplicación que te conecta directamente con campañas publicitarias y te permite ganar recompensas por participar en ellas. Es más que una simple app; es tu portal hacia una nueva forma de generar contenido y ser recompensado por ello.',

    ...
    es: {
       ...
       login: {
        ...
        signUp: {
          ...
          email: "Correo electrónico",
          password: "Contraseña",
          specificationPassword: "La contraseña debe contener: entre 6 y 15 caracteres, al menos una letra mayúscula, una  minúscula, un número y un caracter especial (!@#$%^&*()-_=+{}[]:;'\"<>,?/|\\`~.)",

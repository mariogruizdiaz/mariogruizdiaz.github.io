                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="single-blog-card card gray-light-bg border-0 shadow-sm my-3">
                            ...
                            <div className="card-body">
                                ...
                                <h3 className="h5 mb-2 card-title"><a href="/#/androidInstallGuide">{this.props.dictionary.guides.android.install.smallCard.title}</a></h3>
                                <p className="card-text">{this.props.dictionary.guides.android.install.smallCard.subtitle}</p>
